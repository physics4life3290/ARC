...
function Construct2DSpherical(domain_length::Float64, zones::Int, θzones::Int, ghost_zones::Int, grid_center::Float64, units::String)
    ...
    cell_areas = rcoord.spacing^2 * thetacoord.spacing .* ones(zones, θzones)
    ...
    return SphericalGrid2D(rcoord, thetacoord, rbounds, thetabounds, rghost_bounds, thetaghost_bounds, cell_areas, units)
end